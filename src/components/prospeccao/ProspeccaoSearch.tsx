          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 rounded-lg border px-3 py-2 text-sm font-medium transition-colors ${
                metodo === "aisa" ? "border-orange-600 bg-orange-50 text-orange-700" : "border-gray-200 text-gray-500"
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 rounded-lg border px-3 py-2 text-sm font-medium transition-colors ${
                metodo === "places" ? "border-orange-600 bg-orange-50 text-orange-700" : "border-gray-200 text-gray-500"
              }`}
            >
              Google Maps (rápido)
                ...
                {(["todos", "sem-site", "com-site"] as FiltroSite[]).map((opcao) => (
                  <button
                    ...
                    className={`rounded-full px-2.5 py-1 ${
                      filtroSite === opcao ? "bg-orange-100 text-orange-700 font-medium" : "bg-gray-100 text-gray-500"
                    }`}
                  >
      ...
      {(aisaResults || placesResults) && (
        <>
          <p className="text-sm text-gray-600">
            {totalResults} empresa(s) encontrada(s) · <strong className="text-orange-600">{imported} nova(s) adicionada(s) como Lead</strong> no{" "}
                  ...
                  <CardContent className="p-4 space-y-2">
                    ...
                    {r.whatsappLink ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs text-emerald-600 flex items-center gap-1.5 hover:underline"
                      >
                    ...
                    {r.instagramUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs text-gray-500 flex items-center gap-1.5 hover:underline truncate"
                      >
                    ...
                    {r.googleMapsUrl && (
                      <a href={r.googleMapsUrl} target="_blank" rel="noreferrer" className="text-xs text-orange-600 hover:underline">
